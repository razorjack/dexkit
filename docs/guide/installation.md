...
This copies reference docs into `app/operations/`, `app/events/`, `app/forms/`, and `app/queries/` (only directories that exist). Re-run after upgrading dexkit. See [LLM Guides](/tooling/llm-guides) for details.
