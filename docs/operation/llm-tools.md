...
`Dex::Tool` turns your operations into tools that LLMs can call directly. It builds on [ruby-llm](https://github.com/crmne/ruby-llm) and uses the [registry](/tooling/registry) and [JSON Schema export](/tooling/registry#json-schema) to generate tool definitions automatically.
