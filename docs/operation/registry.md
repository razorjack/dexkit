---
description: Describe operations and events, browse the registry, and export contracts as hashes or JSON Schema for tooling and documentation.
---

# Registry & Export

dexkit tracks every named Operation, Event, and Handler subclass in a registry. Combined with the `description` DSL and export methods, this gives you programmatic access to your entire API surface – useful for admin panels, documentation generators, and LLM tooling.
